        ...
        return `
            <div class="character-card" data-id="${character.id}">
                ...
                <div class="character-details">
                    ...
                    ${character.coordinates ? `<p><strong>🗺️ Coordinates:</strong> [${character.coordinates[0]}, ${character.coordinates[1]}]</p>` : '<p><strong>Coordinates:</strong> <em style="color: orange;">Not set</em></p>'}
                ...
                <div class="movement-entry" data-movement-id="${movement.id}">
                    <div class="movement-entry-header">
                        ...
                        <div class="movement-actions">
                            <button class="btn-secondary movement-edit-btn" data-movement="${movement.id}" title="✏️">Edit</button>
                            <button class="btn-danger movement-delete-btn" data-movement="${movement.id}" title="🗑️">Delete</button>
                        </div>
                    </div>

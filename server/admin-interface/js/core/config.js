// admin-public/js/core/config.js - Shared configuration for locations and other entities
...
const AdenaiConfig = {
    ...
    system: {
        // Review system cleanup configuration
        reviewCleanup: {
            // Number of days to retain approved/rejected reviews
            retentionDays: 30,
            // Whether to auto-cleanup on each new review submission
            autoCleanup: true,
            // Maximum number of reviews to keep regardless of age
            maxReviews: 1000
        },

        // Timeline configuration
        timeline: {
            // Default timeline range in years
            defaultRangeYears: 3,
            // Maximum segments to render at once
            maxSegments: 500,
            // Animation speed for timeline playback (ms per day)
            animationSpeed: 100
        }
    },
